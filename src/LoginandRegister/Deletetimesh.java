 ...
 * @author Dell
 */
public class Deletetimesh extends javax.swing.JFrame {

    /**
     * Creates new form Deletetimesh
     */
    public Deletetimesh() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE TIMESHEET DETAILS");

        records.setBackground(new java.awt.Color(255, 255, 153));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "tid", "tname", "ttitle", "tworkhr", "ttype", "date"
            }
        ));
        ...
        jTextField2.setText("To Delete Timesheet Details, Write his/her ID");
    ...
    private void recordsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recordsActionPerformed
        ...
        try{
            ...
            String SQL= "select * from addtimesheet";
            PreparedStatement pst= con.prepareStatement(SQL);
            ResultSet rs= pst.executeQuery();
            DefaultTableModel tm= (DefaultTableModel)table.getModel();
            tm.setRowCount(0);
            while(rs.next()){
                Object o[]= {rs.getInt("tid"), rs.getString("tname"), rs.getString("ttitle"), rs.getInt("tworkhr"), rs.getString("ttype"), rs. getDate("date")};
                tm.addRow(o);
            }
        }
        catch (Exception e){
    ...
    private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebuttonActionPerformed
        ...
        try{
            Connection con = DBConnection.getConnection();
            Statement st = con.createStatement();
            String SQL= "delete from addtimesheet where tid= "+di;
            PreparedStatement pst= con.prepareStatement(SQL);
            pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deletetimesh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deletetimesh().setVisible(true);
            }
        });
    }
