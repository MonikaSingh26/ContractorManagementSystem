 ...
 * @author Dell
 */
public class Viewtimedetails extends javax.swing.JFrame {

    /**
     * Creates new form Viewtimedetails
     */
    public Viewtimedetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VIEW TIMESHEET DETAILS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viewtimedetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Viewtimedetails().setVisible(true);
            }
        });
    }
