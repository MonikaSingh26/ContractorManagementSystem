 ...
 * @author Dell
 */
public class Viewsaldetails extends javax.swing.JFrame {

    /**
     * Creates new form Viewsaldetails
     */
    public Viewsaldetails() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viewsaldetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Viewsaldetails().setVisible(true);
            }
        });
    }
