 ...
 * @author Dell
 */
public class Deletelv extends javax.swing.JFrame {

    /**
     * Creates new form Deletelv
     */
    public Deletelv() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE LEAVE DETAILS ");
        ...
        records.setBackground(new java.awt.Color(255, 153, 204));
        ...
        jTextField2.setText("To Delete a Leave Details, Write his/her ID");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(field, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
    ...
    private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebuttonActionPerformed
        ...
        try{
            Connection con = DBConnection.getConnection();
            Statement st = con.createStatement();
            String SQL= "delete from addleaves where lid= "+di;
            PreparedStatement pst= con.prepareStatement(SQL);
            pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deletelv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
